...
parser = argparse.ArgumentParser(description='Returns'
                                             ...
                                             'person')
parser.add_argument('-f','--first',help='specify'
                                        'first name',
                    type=str,required=False,dest='first_name')
parser.add_argument('-l','--last',help='last name',
                    type=str,required=False,dest='last name')
parser.add_argument('-y',help='year of birth',type=int,
                    required=False,dest='birth_year')
